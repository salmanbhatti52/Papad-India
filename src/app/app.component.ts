...
export class AppComponent {
  ...
  constructor(public config: Config, public alertController: AlertController, private router: Router, public navCtrl: NavController, public translateService: TranslateService, public platform: Platform, private splashScreen: SplashScreen, private statusBar: StatusBar, private appMinimize: AppMinimize, public settings: Settings) {
    this.initializeApp();
  }
